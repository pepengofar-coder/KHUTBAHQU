...
function generateSitemap() {
  ...
  const staticPages = [
    ...
    { path: '/tilawah', priority: '0.7', changefreq: 'monthly' },
    { path: '/murottal-30-juz', priority: '0.7', changefreq: 'monthly' },
    ...
    { path: '/mode-perjalanan', priority: '0.5', changefreq: 'monthly' },
    { path: '/favorit', priority: '0.4', changefreq: 'monthly' },
