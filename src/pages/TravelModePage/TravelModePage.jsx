...
export default function TravelModePage() {
  ...
  return (
    <div className={`travel-mode-page ${isAudioOrYoutube ? 'media-player-active' : ''}`}>
      ...
      <div className="travel-mode-desktop-layout container">
        <div className="travel-mode-main-col">
      ...
      {/* Playlists Grid */}
      <section className="travel-playlists">
      ...
      <section id="doa-safar-card" className="doa-safar-section">
      ...
      <section className="sleep-timer-shortcut">
      ...
      {/* Desktop Right Side Panel */}
        <div className="travel-mode-side-col-wrapper">
          <aside className="travel-mode-side-col" ref={desktopSheetRef}>
            {selectedPlaylist ? (
              renderPlaylistDetail()
            ) : (
              <div className="travel-side-placeholder">
                <Play size={48} className="placeholder-icon" />
                <h3>Pilih Audio Safar</h3>
                <p>Silakan pilih Radio Dakwah, Kajian, atau Tilawah dari daftar di samping untuk mulai memutar.</p>
              </div>
            )}
          </aside>
        </div>
      ...
      {/* Playlist Details Bottom Sheet (Mobile) */}
      {selectedPlaylist && (
        <div className="playlist-sheet-backdrop" onClick={() => setSelectedPlaylistId(null)}>
          <div className="playlist-sheet" onClick={(e) => e.stopPropagation()} ref={mobileSheetRef}>
