...
import { Compass, Calendar, Plane, BookOpen, ChevronRight } from 'lucide-react';

export default function SafarHero({ onStartGuidance, onOpenDua }) {
  return (
      ...
      <div className="safar-hero__content">
        ...
        >
          ...
          >
            ...
            {/* Suitcase (Sleek Minimalist Design) */}
